...
/**
 * Creates a map to and from UD and EAGLES
 * <p>TAGSET FREELING:     https://talp-upc.gitbook.io/freeling-4-0-user-manual/tagsets/tagset-it </p>
 * <p>TAGSET UD2.0:        https://universaldependencies.org/u/pos/index.html </p>
 * <p>Partial EAGLES list: https://github.com/slavpetrov/universal-pos-tags</p>
...
public class EAGLESTranslator extends POSTranslator {
    ...
    Map<String, List<String>> createToPos() {
        ...
        //PROPN
        pos.put("PROPN", Arrays.asList("NP00000","NP00G00","NP00O00","NP00SP0","NP00V00"));
    ...
    Map<String, List<String>> createToUD() {
        ...
        ud.put("AQ0FS00", Arrays.asList("ADJ"));
