...
import se.gu.spraakbanken.fcs.endpoint.korp.*;
import java.net.URI;
...
import se.gu.spraakbanken.fcs.endpoint.ilc4clarin.korp.cqp.POSTranslator;
import se.gu.spraakbanken.fcs.endpoint.ilc4clarin.korp.cqp.POSTranslatorFactory;
...
import static se.gu.spraakbanken.fcs.endpoint.ilc4clarin.korp.data.json.pojo.info.CorporaInfo.getIlc4ClarinCorporaInfo;
 ...
 */
public class Ilc4ClarinKorpSRUSearchResultSet extends SRUSearchResultSet {
    ...
    private static Logger LOG = LoggerFactory.getLogger(Ilc4ClarinKorpSRUSearchResultSet.class);
     ...
     *
     */
    protected Ilc4ClarinKorpSRUSearchResultSet(SRUServerConfig serverConfig, SRURequest request, SRUDiagnosticList diagnostics, final Query resultSet, final String query, final CorporaInfo corporaInfo) {
        super(diagnostics);
    ...
    protected Ilc4ClarinKorpSRUSearchResultSet(SRUServerConfig serverConfig, SRUDiagnosticList diagnostics, final Query resultSet, final String query, final CorporaInfo corporaInfo) {
        super(diagnostics);
        this.serverConfig = serverConfig;
        this.resultSet = resultSet;
        this.query = query;
...
//        URI posLayerId = URI.create("http://spraakbanken.gu.se/ns/fcs/layer/pos");
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ilc4ClarinKorpSRUSearchResultSet.class.getName()).log(Level.SEVERE, null, ex);
        }
