...
public class CorporaInfo {
    ...
    public static CorporaInfo getIlc4ClarinCorporaInfo(Properties prop, final List<String> corpora) {
        ...
        LOG.debug("se.gu.spraakbanken.fcs.endpoint.korp.data.json.pojo.info.CorporaInfo.getIlc4ClarinCorporaInfo() " + wsString);
...
//	final String queryString = "command=info&corpus=";
        ...
        LOG.debug("se.gu.spraakbanken.fcs.endpoint.korp.data.json.pojo.info.CorporaInfo.getIlc4ClarinCorporaInfo() " + corporaValues);
    ...
    /**
     * Extract available corpora form property CTX2CORPORA. It is important to
     * filter production corpora only
     *
     * @param prop the property file
     * @param sources the list of resources to filter
     * @return the subset of corpora filtered by sources
     */
    public static CorporaInfo selectedCorporaInfo(Properties prop, String sources) {
        ...
        String ctx, corpus;
        LOG.debug("se.gu.spraakbanken.fcs.endpoint.ilc4clarin.korp.data.json.pojo.info.selectedCorporaInfo() '{}'", sources);
        LOG.debug("se.gu.spraakbanken.fcs.endpoint.ilc4clarin.korp.data.json.pojo.info.selectedCorporaInfo() mapped '{}'", mappedList);
